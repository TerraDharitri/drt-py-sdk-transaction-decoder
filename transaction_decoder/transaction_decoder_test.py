...
class TestTransactionDecoder:
    def test_nft_smart_contract_call(self) -> None:
        ...
        tx_to_decode.data = "RENEVE5GVFRyYW5zZmVyQDRjNGI0ZDRmNDEyZDYxNjE2MjM5MzEzMEAyZmI0ZTlAZTQwZjE2OTk3MTY1NWU2YmIwNGNAMDAwMDAwMDAwMDAwMDAwMDA1MDBkZjNiZWJlMWFmYTEwYzQwOTI1ZTgzM2MxNGE0NjBlMTBhODQ5ZjUwYTQ2OEA3Mzc3NjE3MDVmNmM2YjZkNmY2MTVmNzQ2ZjVmNzI2NTc3NjFAMGIzNzdmMjYxYzNjNzE5MUA="
    ...
    def test_multi_esdt_nft_transfer(self):
        ...
        tx_to_decode.value = "0"
        tx_to_decode.data = ""
    ...
    def test_esdt_transfer(self):
        ...
        tx_to_decode.value = "0"
        tx_to_decode.data = (
            "RENEVFRyYW5zZmVyQDU0NDU1MzU0MmQzMjY1MzQzMDY0MzdAMDI1NDBiZTQwMA=="
        )
